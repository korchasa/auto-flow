...
- [FR-E71](requirements-engine/06-distribution-and-housekeeping.md#371-fr-e71-codex-plugin-install-path) — Codex plugin install path (Codex-native payload + auto-MCP, no manual `config.toml` patch) — [ ]
