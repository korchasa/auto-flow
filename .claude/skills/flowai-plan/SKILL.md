...
name: flowai-plan
description: >-
  Create critiqued plan in documents/tasks/ using GODS framework with
...
Create a clear, critiqued plan in `./documents/tasks/` using the GODS framework.
...
3. **Draft Framework (G-O-D)**
   - Create Goal, Overview, Definition of Done in `documents/tasks/<date>-<slug>.md` following `### GODS Format` from AGENTS.md.
